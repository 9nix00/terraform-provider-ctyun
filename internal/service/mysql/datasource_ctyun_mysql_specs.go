...
var (
	_ datasource.DataSource              = &CtyunMysqlSpecs{}
	_ datasource.DataSourceWithConfigure = &CtyunMysqlSpecs{}
)
...
func (c *CtyunMysqlSpecs) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	...
	var config CtyunMysqlSpecsConfig
	...
	var specs []CtyunMysqlSpecInfoModel
	for _, specItem := range returnObjData {
		var spec CtyunMysqlSpecInfoModel
