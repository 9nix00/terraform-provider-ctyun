...
var (
	_ datasource.DataSource              = &CtyunMysqlAssociationEips{}
	_ datasource.DataSourceWithConfigure = &CtyunMysqlAssociationEips{}
)
...
func NewCtyunMysqlAssociationEips() *CtyunMysqlAssociationEips {
	return &CtyunMysqlAssociationEips{}
}
...
func (c *CtyunMysqlAssociationEips) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	...
	var config CtyunMysqlAssociationEipsConfig
...
type CtyunMysqlAssociationEipsConfig struct {
