...
// CcseListCronHorizontalPodAutoscalersApi
/* 查询指定集群下的CronHorizontalPodAutoscaler列表
...
func NewCcseListCronHorizontalPodAutoscalersApi(client *core.CtyunClient) *CcseListCronHorizontalPodAutoscalersApi {
	return &CcseListCronHorizontalPodAutoscalersApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/autoscaling.ctyun.com/v1beta1/namespaces/{namespaceName}/cronhorizontalpodautoscalers",
...
func (a *CcseListCronHorizontalPodAutoscalersApi) Do(ctx context.Context, credential core.Credential, req *CcseListCronHorizontalPodAutoscalersRequest) (*CcseListCronHorizontalPodAutoscalersResponse, error) {
	...
	var resp CcseListCronHorizontalPodAutoscalersResponse
