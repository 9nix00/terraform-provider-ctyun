...
// CcseUpdateStorageClassApi
/* 更新指定集群下的StorageClass
...
func NewCcseUpdateStorageClassApi(client *core.CtyunClient) *CcseUpdateStorageClassApi {
	return &CcseUpdateStorageClassApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPut,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/storage.k8s.io/v1/storageclasses/{StorageClassName}",
...
func (a *CcseUpdateStorageClassApi) Do(ctx context.Context, credential core.Credential, req *CcseUpdateStorageClassRequest) (*CcseUpdateStorageClassResponse, error) {
	...
	builder = builder.ReplaceUrl("StorageClassName", req.StorageClassName)
	...
	var resp CcseUpdateStorageClassResponse
