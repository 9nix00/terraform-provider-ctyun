...
func NewCcseDeleteServiceApi(client *core.CtyunClient) *CcseDeleteServiceApi {
	return &CcseDeleteServiceApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodDelete,
			UrlPath:      "/v2/cce/clusters/{clusterId}/api/v1/namespaces/{namespaceName}/services/{serviceName}",
...
func (a *CcseDeleteServiceApi) Do(ctx context.Context, credential core.Credential, req *CcseDeleteServiceRequest) (*CcseDeleteServiceResponse, error) {
	...
	builder = builder.ReplaceUrl("serviceName", req.ServiceName)
	...
	var resp CcseDeleteServiceResponse
