...
// CcseGetStatefulSetApi
/* 查询指定集群下的StatefulSet详情
...
func NewCcseGetStatefulSetApi(client *core.CtyunClient) *CcseGetStatefulSetApi {
	return &CcseGetStatefulSetApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/apps/v1/namespaces/{namespaceName}/statefulsets/{statefulsetName}",
...
func (a *CcseGetStatefulSetApi) Do(ctx context.Context, credential core.Credential, req *CcseGetStatefulSetRequest) (*CcseGetStatefulSetResponse, error) {
	...
	builder = builder.ReplaceUrl("statefulsetName", req.StatefulsetName)
	...
	var resp CcseGetStatefulSetResponse
