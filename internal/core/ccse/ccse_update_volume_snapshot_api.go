...
// CcseUpdateVolumeSnapshotApi
/* 更新指定集群下的VolumeSnapshot
...
func NewCcseUpdateVolumeSnapshotApi(client *core.CtyunClient) *CcseUpdateVolumeSnapshotApi {
	return &CcseUpdateVolumeSnapshotApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPut,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/snapshot.storage.k8s.io/v1/namespaces/{namespaceName}/volumesnapshots/{volumeSnapshotName}",
...
func (a *CcseUpdateVolumeSnapshotApi) Do(ctx context.Context, credential core.Credential, req *CcseUpdateVolumeSnapshotRequest) (*CcseUpdateVolumeSnapshotResponse, error) {
	...
	builder = builder.ReplaceUrl("volumeSnapshotName", req.VolumeSnapshotName)
	...
	var resp CcseUpdateVolumeSnapshotResponse
