...
func NewCcseDeleteJobApi(client *core.CtyunClient) *CcseDeleteJobApi {
	return &CcseDeleteJobApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodDelete,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/batch/v1/namespaces/{namespaceName}/jobs/{jobName}",
...
func (a *CcseDeleteJobApi) Do(ctx context.Context, credential core.Credential, req *CcseDeleteJobRequest) (*CcseDeleteJobResponse, error) {
	...
	builder = builder.ReplaceUrl("jobName", req.JobName)
	...
	var resp CcseDeleteJobResponse
