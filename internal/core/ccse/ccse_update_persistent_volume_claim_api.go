...
// CcseUpdatePersistentVolumeClaimApi
/* 更新指定集群下的PersistentVolumeClaim资源
...
func NewCcseUpdatePersistentVolumeClaimApi(client *core.CtyunClient) *CcseUpdatePersistentVolumeClaimApi {
	return &CcseUpdatePersistentVolumeClaimApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPut,
			UrlPath:      "/v2/cce/clusters/{clusterId}/api/v1/namespaces/{namespaceName}/persistentvolumeclaims/{PersistentVolumeClaimName}",
...
func (a *CcseUpdatePersistentVolumeClaimApi) Do(ctx context.Context, credential core.Credential, req *CcseUpdatePersistentVolumeClaimRequest) (*CcseUpdatePersistentVolumeClaimResponse, error) {
	...
	builder = builder.ReplaceUrl("PersistentVolumeClaimName", req.PersistentVolumeClaimName)
	...
	var resp CcseUpdatePersistentVolumeClaimResponse
