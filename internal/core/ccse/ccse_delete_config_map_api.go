...
func NewCcseDeleteConfigMapApi(client *core.CtyunClient) *CcseDeleteConfigMapApi {
	return &CcseDeleteConfigMapApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodDelete,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/apps/v1/namespaces/{namespaceName}/configmaps/{configmapName}",
...
func (a *CcseDeleteConfigMapApi) Do(ctx context.Context, credential core.Credential, req *CcseDeleteConfigMapRequest) (*CcseDeleteConfigMapResponse, error) {
	...
	builder = builder.ReplaceUrl("configmapName", req.ConfigmapName)
	...
	var resp CcseDeleteConfigMapResponse
