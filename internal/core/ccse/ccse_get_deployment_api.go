...
// CcseGetDeploymentApi
/* 查询指定集群下的deployment详情
...
func NewCcseGetDeploymentApi(client *core.CtyunClient) *CcseGetDeploymentApi {
	return &CcseGetDeploymentApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/apps/v1/namespaces/{namespaceName}/deployments/{deploymentName}",
...
func (a *CcseGetDeploymentApi) Do(ctx context.Context, credential core.Credential, req *CcseGetDeploymentRequest) (*CcseGetDeploymentResponse, error) {
	...
	builder = builder.ReplaceUrl("deploymentName", req.DeploymentName)
	...
	var resp CcseGetDeploymentResponse
