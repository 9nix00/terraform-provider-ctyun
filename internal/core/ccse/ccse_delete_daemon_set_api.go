...
func NewCcseDeleteDaemonSetApi(client *core.CtyunClient) *CcseDeleteDaemonSetApi {
	return &CcseDeleteDaemonSetApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodDelete,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/apps/v1/namespaces/{namespaceName}/daemonsets/{daemonsetName}",
...
func (a *CcseDeleteDaemonSetApi) Do(ctx context.Context, credential core.Credential, req *CcseDeleteDaemonSetRequest) (*CcseDeleteDaemonSetResponse, error) {
	...
	builder = builder.ReplaceUrl("daemonsetName", req.DaemonsetName)
	...
	var resp CcseDeleteDaemonSetResponse
