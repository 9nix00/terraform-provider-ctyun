...
// CcseUpdateReplicaSetApi
/* 更新指定集群下的ReplicaSet资源
...
func NewCcseUpdateReplicaSetApi(client *core.CtyunClient) *CcseUpdateReplicaSetApi {
	return &CcseUpdateReplicaSetApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPut,
			UrlPath:      "/v2/cce/clusters/{clusterId}/apis/apps/v1/namespaces/{namespaceName}/replicasets/{ReplicaSetName}",
...
func (a *CcseUpdateReplicaSetApi) Do(ctx context.Context, credential core.Credential, req *CcseUpdateReplicaSetRequest) (*CcseUpdateReplicaSetResponse, error) {
	...
	builder = builder.ReplaceUrl("ReplicaSetName", req.ReplicaSetName)
	...
	var resp CcseUpdateReplicaSetResponse
