...
func (a *CtvpcNewSubnetListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcNewSubnetListRequest) (*CtvpcNewSubnetListResponse, error) {
	...
	var resp CtvpcNewSubnetListResponse
