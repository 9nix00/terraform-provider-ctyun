...
func NewCtvpcNewACLListApi(client *core.CtyunClient) *CtvpcNewACLListApi {
	return &CtvpcNewACLListApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/acl/new-list",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcNewACLListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcNewACLListRequest) (*CtvpcNewACLListResponse, error) {
	...
	var resp CtvpcNewACLListResponse
