...
func NewCtvpcDeletePrivateZoneApi(client *core.CtyunClient) *CtvpcDeletePrivateZoneApi {
	return &CtvpcDeletePrivateZoneApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/private-zone/delete",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeletePrivateZoneApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeletePrivateZoneRequest) (*CtvpcDeletePrivateZoneResponse, error) {
	...
	var resp CtvpcDeletePrivateZoneResponse
