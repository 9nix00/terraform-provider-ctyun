...
func NewCtvpcQueryLabelsByResourceApi(client *core.CtyunClient) *CtvpcQueryLabelsByResourceApi {
	return &CtvpcQueryLabelsByResourceApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/labels/query_labels_by_resource",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcQueryLabelsByResourceApi) Do(ctx context.Context, credential core.Credential, req *CtvpcQueryLabelsByResourceRequest) (*CtvpcQueryLabelsByResourceResponse, error) {
	...
	var resp CtvpcQueryLabelsByResourceResponse
