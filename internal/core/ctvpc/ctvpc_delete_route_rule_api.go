...
func NewCtvpcDeleteRouteRuleApi(client *core.CtyunClient) *CtvpcDeleteRouteRuleApi {
	return &CtvpcDeleteRouteRuleApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/route-table/delete-rule",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteRouteRuleApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteRouteRuleRequest) (*CtvpcDeleteRouteRuleResponse, error) {
	...
	var resp CtvpcDeleteRouteRuleResponse
