...
func NewCtvpcPrefixlistUpdateApi(client *core.CtyunClient) *CtvpcPrefixlistUpdateApi {
	return &CtvpcPrefixlistUpdateApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/prefixlist/update",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcPrefixlistUpdateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcPrefixlistUpdateRequest) (*CtvpcPrefixlistUpdateResponse, error) {
	...
	var resp CtvpcPrefixlistUpdateResponse
