...
func NewCtvpcDisassociateEipApi(client *core.CtyunClient) *CtvpcDisassociateEipApi {
	return &CtvpcDisassociateEipApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcDisassociateEipApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDisassociateEipRequest) (*CtvpcDisassociateEipResponse, error) {
	...
	var resp CtvpcDisassociateEipResponse
