...
func NewCtvpcRefuseEndpointApplyApi(client *core.CtyunClient) *CtvpcRefuseEndpointApplyApi {
	return &CtvpcRefuseEndpointApplyApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpce/reject-endpoint-apply",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcRefuseEndpointApplyApi) Do(ctx context.Context, credential core.Credential, req *CtvpcRefuseEndpointApplyRequest) (*CtvpcRefuseEndpointApplyResponse, error) {
	...
	var resp CtvpcRefuseEndpointApplyResponse
