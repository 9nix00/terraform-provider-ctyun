...
// CtvpcNewEndpointServicesListApi
/* 查看终端节点服务列表
...
func NewCtvpcNewEndpointServicesListApi(client *core.CtyunClient) *CtvpcNewEndpointServicesListApi {
	return &CtvpcNewEndpointServicesListApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/vpce/new-list-endpoint-service",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcNewEndpointServicesListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcNewEndpointServicesListRequest) (*CtvpcNewEndpointServicesListResponse, error) {
	...
	var resp CtvpcNewEndpointServicesListResponse
