...
func NewCtvpcModifySgIngressRuleApi(client *core.CtyunClient) *CtvpcModifySgIngressRuleApi {
	return &CtvpcModifySgIngressRuleApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcModifySgIngressRuleApi) Do(ctx context.Context, credential core.Credential, req *CtvpcModifySgIngressRuleRequest) (*CtvpcModifySgIngressRuleResponse, error) {
	...
	var resp CtvpcModifySgIngressRuleResponse
