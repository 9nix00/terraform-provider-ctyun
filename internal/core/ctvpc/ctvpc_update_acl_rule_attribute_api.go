...
// CtvpcUpdateAclRuleAttributeApi
/* 修改 Acl 规则列表属性
...
func NewCtvpcUpdateAclRuleAttributeApi(client *core.CtyunClient) *CtvpcUpdateAclRuleAttributeApi {
	return &CtvpcUpdateAclRuleAttributeApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/acl-rule/update",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcUpdateAclRuleAttributeApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUpdateAclRuleAttributeRequest) (*CtvpcUpdateAclRuleAttributeResponse, error) {
	...
	var resp CtvpcUpdateAclRuleAttributeResponse
