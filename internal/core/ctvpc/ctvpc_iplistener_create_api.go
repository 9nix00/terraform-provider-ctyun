...
func NewCtvpcIplistenerCreateApi(client *core.CtyunClient) *CtvpcIplistenerCreateApi {
	return &CtvpcIplistenerCreateApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcIplistenerCreateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcIplistenerCreateRequest) (*CtvpcIplistenerCreateResponse, error) {
	...
	var resp CtvpcIplistenerCreateResponse
