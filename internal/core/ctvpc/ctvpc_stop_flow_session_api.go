...
func NewCtvpcStopFlowSessionApi(client *core.CtyunClient) *CtvpcStopFlowSessionApi {
	return &CtvpcStopFlowSessionApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/flowsession/stop",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcStopFlowSessionApi) Do(ctx context.Context, credential core.Credential, req *CtvpcStopFlowSessionRequest) (*CtvpcStopFlowSessionResponse, error) {
	...
	var resp CtvpcStopFlowSessionResponse
