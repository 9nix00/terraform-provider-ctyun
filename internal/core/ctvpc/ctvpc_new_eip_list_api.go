...
func NewCtvpcNewEipListApi(client *core.CtyunClient) *CtvpcNewEipListApi {
	return &CtvpcNewEipListApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/eip/new-list",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcNewEipListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcNewEipListRequest) (*CtvpcNewEipListResponse, error) {
	...
	var resp CtvpcNewEipListResponse
