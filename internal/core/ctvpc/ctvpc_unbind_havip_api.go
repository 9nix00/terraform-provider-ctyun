...
func NewCtvpcUnbindHavipApi(client *core.CtyunClient) *CtvpcUnbindHavipApi {
	return &CtvpcUnbindHavipApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/havip/unbind",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcUnbindHavipApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUnbindHavipRequest) (*CtvpcUnbindHavipResponse, error) {
	...
	var resp CtvpcUnbindHavipResponse
