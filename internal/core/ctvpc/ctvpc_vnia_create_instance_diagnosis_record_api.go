...
// CtvpcVniaCreateInstanceDiagnosisRecordApi
/* 创建实例诊断记录
...
func NewCtvpcVniaCreateInstanceDiagnosisRecordApi(client *core.CtyunClient) *CtvpcVniaCreateInstanceDiagnosisRecordApi {
	return &CtvpcVniaCreateInstanceDiagnosisRecordApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vnia/create-instance-diagnosis-record",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcVniaCreateInstanceDiagnosisRecordApi) Do(ctx context.Context, credential core.Credential, req *CtvpcVniaCreateInstanceDiagnosisRecordRequest) (*CtvpcVniaCreateInstanceDiagnosisRecordResponse, error) {
	...
	var resp CtvpcVniaCreateInstanceDiagnosisRecordResponse
