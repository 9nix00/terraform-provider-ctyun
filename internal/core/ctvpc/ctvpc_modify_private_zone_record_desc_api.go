...
// CtvpcModifyPrivateZoneRecordDescApi
/* 修改内网dns记录描述信息
...
func NewCtvpcModifyPrivateZoneRecordDescApi(client *core.CtyunClient) *CtvpcModifyPrivateZoneRecordDescApi {
	return &CtvpcModifyPrivateZoneRecordDescApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/private-zone-record/modify-desc",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcModifyPrivateZoneRecordDescApi) Do(ctx context.Context, credential core.Credential, req *CtvpcModifyPrivateZoneRecordDescRequest) (*CtvpcModifyPrivateZoneRecordDescResponse, error) {
	...
	var resp CtvpcModifyPrivateZoneRecordDescResponse
