...
func NewCtvpcListSecurityGroupsApi(client *core.CtyunClient) *CtvpcListSecurityGroupsApi {
	return &CtvpcListSecurityGroupsApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/vpc/query-security-groups",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcListSecurityGroupsApi) Do(ctx context.Context, credential core.Credential, req *CtvpcListSecurityGroupsRequest) (*CtvpcListSecurityGroupsResponse, error) {
	...
	var resp CtvpcListSecurityGroupsResponse
