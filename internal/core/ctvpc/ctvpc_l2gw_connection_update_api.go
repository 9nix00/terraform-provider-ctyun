...
// CtvpcL2gwConnectionUpdateApi
/* 修改l2gw_connection的属性：名称、描述。
...
func NewCtvpcL2gwConnectionUpdateApi(client *core.CtyunClient) *CtvpcL2gwConnectionUpdateApi {
	return &CtvpcL2gwConnectionUpdateApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/l2gw_connection/update",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcL2gwConnectionUpdateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcL2gwConnectionUpdateRequest) (*CtvpcL2gwConnectionUpdateResponse, error) {
	...
	var resp CtvpcL2gwConnectionUpdateResponse
