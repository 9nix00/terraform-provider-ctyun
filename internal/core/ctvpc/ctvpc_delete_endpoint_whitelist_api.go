...
// CtvpcDeleteEndpointWhitelistApi
/* 删除终端节点白名单
...
func NewCtvpcDeleteEndpointWhitelistApi(client *core.CtyunClient) *CtvpcDeleteEndpointWhitelistApi {
	return &CtvpcDeleteEndpointWhitelistApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpce/delete-endpoint-whitelist",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteEndpointWhitelistApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteEndpointWhitelistRequest) (*CtvpcDeleteEndpointWhitelistResponse, error) {
	...
	var resp CtvpcDeleteEndpointWhitelistResponse
