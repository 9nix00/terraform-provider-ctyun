...
func NewCtvpcAttachEipToPortApi(client *core.CtyunClient) *CtvpcAttachEipToPortApi {
	return &CtvpcAttachEipToPortApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/eip/attach-port-vm",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcAttachEipToPortApi) Do(ctx context.Context, credential core.Credential, req *CtvpcAttachEipToPortRequest) (*CtvpcAttachEipToPortResponse, error) {
	...
	var resp CtvpcAttachEipToPortResponse
