...
func NewCtvpcVpcDeleteSubnetApi(client *core.CtyunClient) *CtvpcVpcDeleteSubnetApi {
	return &CtvpcVpcDeleteSubnetApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcVpcDeleteSubnetApi) Do(ctx context.Context, credential core.Credential, req *CtvpcVpcDeleteSubnetRequest) (*CtvpcVpcDeleteSubnetResponse, error) {
	...
	var resp CtvpcVpcDeleteSubnetResponse
