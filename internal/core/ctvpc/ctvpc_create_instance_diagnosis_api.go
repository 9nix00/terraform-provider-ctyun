...
// CtvpcCreateInstanceDiagnosisApi
/* 创建实例诊断
...
func NewCtvpcCreateInstanceDiagnosisApi(client *core.CtyunClient) *CtvpcCreateInstanceDiagnosisApi {
	return &CtvpcCreateInstanceDiagnosisApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vnia/create-instance-diagnosis",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcCreateInstanceDiagnosisApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateInstanceDiagnosisRequest) (*CtvpcCreateInstanceDiagnosisResponse, error) {
	...
	var resp CtvpcCreateInstanceDiagnosisResponse
