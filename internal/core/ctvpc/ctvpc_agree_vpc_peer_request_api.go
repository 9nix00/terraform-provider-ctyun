...
func NewCtvpcAgreeVpcPeerRequestApi(client *core.CtyunClient) *CtvpcAgreeVpcPeerRequestApi {
	return &CtvpcAgreeVpcPeerRequestApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/vpcpeer/agree-request",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcAgreeVpcPeerRequestApi) Do(ctx context.Context, credential core.Credential, req *CtvpcAgreeVpcPeerRequestRequest) (*CtvpcAgreeVpcPeerRequestResponse, error) {
	...
	var resp CtvpcAgreeVpcPeerRequestResponse
