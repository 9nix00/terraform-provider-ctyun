...
func NewCtvpcRenewNatGatewayApi(client *core.CtyunClient) *CtvpcRenewNatGatewayApi {
	return &CtvpcRenewNatGatewayApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcRenewNatGatewayApi) Do(ctx context.Context, credential core.Credential, req *CtvpcRenewNatGatewayRequest) (*CtvpcRenewNatGatewayResponse, error) {
	...
	var resp CtvpcRenewNatGatewayResponse
