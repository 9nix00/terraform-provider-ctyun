...
func NewCtvpcGwlbUpdateTargetGroupApi(client *core.CtyunClient) *CtvpcGwlbUpdateTargetGroupApi {
	return &CtvpcGwlbUpdateTargetGroupApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcGwlbUpdateTargetGroupApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbUpdateTargetGroupRequest) (*CtvpcGwlbUpdateTargetGroupResponse, error) {
	...
	var resp CtvpcGwlbUpdateTargetGroupResponse
