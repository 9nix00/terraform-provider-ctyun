...
// CtvpcUnassignSecondaryPrivateIPsFromPortApi
/* 网卡解绑辅助私网IP
...
func NewCtvpcUnassignSecondaryPrivateIPsFromPortApi(client *core.CtyunClient) *CtvpcUnassignSecondaryPrivateIPsFromPortApi {
	return &CtvpcUnassignSecondaryPrivateIPsFromPortApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ports/unassign-secondary-private-ips",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcUnassignSecondaryPrivateIPsFromPortApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUnassignSecondaryPrivateIPsFromPortRequest) (*CtvpcUnassignSecondaryPrivateIPsFromPortResponse, error) {
	...
	var resp CtvpcUnassignSecondaryPrivateIPsFromPortResponse
