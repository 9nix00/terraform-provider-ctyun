...
func NewCtvpcCreateAclApi(client *core.CtyunClient) *CtvpcCreateAclApi {
	return &CtvpcCreateAclApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/acl/create",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcCreateAclApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateAclRequest) (*CtvpcCreateAclResponse, error) {
	...
	var resp CtvpcCreateAclResponse
