...
func NewCtvpcPortReplaceVPCApi(client *core.CtyunClient) *CtvpcPortReplaceVPCApi {
	return &CtvpcPortReplaceVPCApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ports/change-vpc",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcPortReplaceVPCApi) Do(ctx context.Context, credential core.Credential, req *CtvpcPortReplaceVPCRequest) (*CtvpcPortReplaceVPCResponse, error) {
	...
	var resp CtvpcPortReplaceVPCResponse
