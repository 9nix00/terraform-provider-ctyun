...
func NewCtvpcSgBatchDetachPortsApi(client *core.CtyunClient) *CtvpcSgBatchDetachPortsApi {
	return &CtvpcSgBatchDetachPortsApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/batch-detach-security-group-ports",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcSgBatchDetachPortsApi) Do(ctx context.Context, credential core.Credential, req *CtvpcSgBatchDetachPortsRequest) (*CtvpcSgBatchDetachPortsResponse, error) {
	...
	var resp CtvpcSgBatchDetachPortsResponse
