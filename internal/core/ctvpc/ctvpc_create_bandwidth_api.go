...
func NewCtvpcCreateBandwidthApi(client *core.CtyunClient) *CtvpcCreateBandwidthApi {
	return &CtvpcCreateBandwidthApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcCreateBandwidthApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateBandwidthRequest) (*CtvpcCreateBandwidthResponse, error) {
	...
	var resp CtvpcCreateBandwidthResponse
