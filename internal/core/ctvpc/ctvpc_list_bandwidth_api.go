...
func NewCtvpcListBandwidthApi(client *core.CtyunClient) *CtvpcListBandwidthApi {
	return &CtvpcListBandwidthApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/bandwidth/list",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcListBandwidthApi) Do(ctx context.Context, credential core.Credential, req *CtvpcListBandwidthRequest) (*CtvpcListBandwidthResponse, error) {
	...
	var resp CtvpcListBandwidthResponse
