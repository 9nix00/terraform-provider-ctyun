...
func NewCtvpcDhcpoptionsetsdeleteApi(client *core.CtyunClient) *CtvpcDhcpoptionsetsdeleteApi {
	return &CtvpcDhcpoptionsetsdeleteApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/dhcpoptionsets/delete",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDhcpoptionsetsdeleteApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDhcpoptionsetsdeleteRequest) (*CtvpcDhcpoptionsetsdeleteResponse, error) {
	...
	var resp CtvpcDhcpoptionsetsdeleteResponse
