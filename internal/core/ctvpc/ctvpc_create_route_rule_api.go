...
func NewCtvpcCreateRouteRuleApi(client *core.CtyunClient) *CtvpcCreateRouteRuleApi {
	return &CtvpcCreateRouteRuleApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/route-table/create-rule",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcCreateRouteRuleApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateRouteRuleRequest) (*CtvpcCreateRouteRuleResponse, error) {
	...
	var resp CtvpcCreateRouteRuleResponse
