...
func NewCtvpcVpceServiceListLabelApi(client *core.CtyunClient) *CtvpcVpceServiceListLabelApi {
	return &CtvpcVpceServiceListLabelApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/vpce/service-list-label",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcVpceServiceListLabelApi) Do(ctx context.Context, credential core.Credential, req *CtvpcVpceServiceListLabelRequest) (*CtvpcVpceServiceListLabelResponse, error) {
	...
	var resp CtvpcVpceServiceListLabelResponse
