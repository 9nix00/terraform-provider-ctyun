...
func (a *CtvpcGwlbListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbListRequest) (*CtvpcGwlbListResponse, error) {
	...
	var resp CtvpcGwlbListResponse
