...
func NewCtvpcUpdateAclAttributeApi(client *core.CtyunClient) *CtvpcUpdateAclAttributeApi {
	return &CtvpcUpdateAclAttributeApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/acl/update",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcUpdateAclAttributeApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUpdateAclAttributeRequest) (*CtvpcUpdateAclAttributeResponse, error) {
	...
	var resp CtvpcUpdateAclAttributeResponse
