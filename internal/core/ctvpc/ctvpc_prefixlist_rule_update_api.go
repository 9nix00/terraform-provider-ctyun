...
// CtvpcPrefixlistRuleUpdateApi
/* 修改 prefixlist_rule 属性
...
func NewCtvpcPrefixlistRuleUpdateApi(client *core.CtyunClient) *CtvpcPrefixlistRuleUpdateApi {
	return &CtvpcPrefixlistRuleUpdateApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/prefixlist_rule/update",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcPrefixlistRuleUpdateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcPrefixlistRuleUpdateRequest) (*CtvpcPrefixlistRuleUpdateResponse, error) {
	...
	var resp CtvpcPrefixlistRuleUpdateResponse
