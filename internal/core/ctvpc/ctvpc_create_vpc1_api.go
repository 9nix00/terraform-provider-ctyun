...
func (a *CtvpcCreateVpc1Api) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateVpc1Request) (*CtvpcCreateVpc1Response, error) {
	...
	var resp CtvpcCreateVpc1Response
