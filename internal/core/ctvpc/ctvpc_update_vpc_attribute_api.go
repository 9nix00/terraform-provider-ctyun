...
func NewCtvpcUpdateVpcAttributeApi(client *core.CtyunClient) *CtvpcUpdateVpcAttributeApi {
	return &CtvpcUpdateVpcAttributeApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcUpdateVpcAttributeApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUpdateVpcAttributeRequest) (*CtvpcUpdateVpcAttributeResponse, error) {
	...
	var resp CtvpcUpdateVpcAttributeResponse
