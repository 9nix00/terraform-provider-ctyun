...
func (a *CtvpcGwlbCreateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbCreateRequest) (*CtvpcGwlbCreateResponse, error) {
	...
	var resp CtvpcGwlbCreateResponse
