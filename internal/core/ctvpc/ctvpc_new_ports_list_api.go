...
func NewCtvpcNewPortsListApi(client *core.CtyunClient) *CtvpcNewPortsListApi {
	return &CtvpcNewPortsListApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/ports/new-list",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcNewPortsListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcNewPortsListRequest) (*CtvpcNewPortsListResponse, error) {
	...
	var resp CtvpcNewPortsListResponse
