...
func NewCtvpcGwlbCreateTargetApi(client *core.CtyunClient) *CtvpcGwlbCreateTargetApi {
	return &CtvpcGwlbCreateTargetApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcGwlbCreateTargetApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbCreateTargetRequest) (*CtvpcGwlbCreateTargetResponse, error) {
	...
	var resp CtvpcGwlbCreateTargetResponse
