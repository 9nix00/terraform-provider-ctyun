...
// CtecsUpdateInstanceSpecV41Api
/* 支持对一台处于关机状态的云主机进行带宽或规格的变更<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项：</b><br/>&emsp;&emsp;成本估算：了解云主机的<a href="https://www.ctyun.cn/document/10026730/10028700">计费项</a><br/>&emsp;&emsp;异步接口：该接口为异步接口，下单成功不代表业务成功
...
func NewCtecsUpdateInstanceSpecV41Api(client *core.CtyunClient) *CtecsUpdateInstanceSpecV41Api {
	return &CtecsUpdateInstanceSpecV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtecsUpdateInstanceSpecV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsUpdateInstanceSpecV41Request) (*CtecsUpdateInstanceSpecV41Response, error) {
	...
	var resp CtecsUpdateInstanceSpecV41Response
