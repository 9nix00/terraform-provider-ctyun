...
// CtecsAffinityGroupbindInstanceCheckV41Api
/* 该接口提供用户云主机加入主机组校验的功能<br />可以根据用户给定的云主机与云主机组，校验当前情况下是否可以将云主机加入主机组。如果可以则返回值中needMigrate字段为0，反之则需要将云主机迁移<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项：</b><br />&emsp;&emsp;处于运行中状态的云主机加入新的云主机组过程中，云主机可能会被重启<br />
...
func NewCtecsAffinityGroupbindInstanceCheckV41Api(client *core.CtyunClient) *CtecsAffinityGroupbindInstanceCheckV41Api {
	return &CtecsAffinityGroupbindInstanceCheckV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtecsAffinityGroupbindInstanceCheckV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsAffinityGroupbindInstanceCheckV41Request) (*CtecsAffinityGroupbindInstanceCheckV41Response, error) {
	...
	var resp CtecsAffinityGroupbindInstanceCheckV41Response
