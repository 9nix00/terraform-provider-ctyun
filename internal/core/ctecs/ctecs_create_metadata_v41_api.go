...
// CtecsCreateMetadataV41Api
/* 为云主机创建元数据，创建成功则会返回创建的元数据信息 <br />元数据的使用参考<a href="https://www.ctyun.cn/document/10026730/10387544">云主机自定义元数据</a><br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项</b><br />&emsp;&emsp;在云主机绑定委托情况下，注意委托对应的元数据键，不要覆盖使用
...
func NewCtecsCreateMetadataV41Api(client *core.CtyunClient) *CtecsCreateMetadataV41Api {
	return &CtecsCreateMetadataV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ecs/metadata/create",
...
func (a *CtecsCreateMetadataV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsCreateMetadataV41Request) (*CtecsCreateMetadataV41Response, error) {
	...
	var resp CtecsCreateMetadataV41Response
