...
// CtecsDeleteMetadataV41Api
/* 删除云主机元数据，删除成功则返回云主机ID<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项</b><br />&emsp;&emsp;在云主机绑定委托情况下，该接口会将委托信息清理，请慎用
...
func NewCtecsDeleteMetadataV41Api(client *core.CtyunClient) *CtecsDeleteMetadataV41Api {
	return &CtecsDeleteMetadataV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ecs/metadata/delete",
...
func (a *CtecsDeleteMetadataV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsDeleteMetadataV41Request) (*CtecsDeleteMetadataV41Response, error) {
	...
	var resp CtecsDeleteMetadataV41Response
