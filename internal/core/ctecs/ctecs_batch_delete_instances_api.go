...
// CtecsBatchDeleteInstancesApi
/* 批量释放云主机，对于包周期的云主机为退订，对于按量付费的云主机为删除<br/><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><br />注意事项</b>：<br />&emsp;&emsp;释放前请确保文件已进行备份，释放后不可恢复。在云主机订购时，一起订购的其他资源，比如绑定的网卡、云硬盘、弹性IP等资源，会一起被释放。非一起订购的资源，比如绑定的网卡、云硬盘、弹性IP等资源会被解绑
...
func NewCtecsBatchDeleteInstancesApi(client *core.CtyunClient) *CtecsBatchDeleteInstancesApi {
	return &CtecsBatchDeleteInstancesApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtecsBatchDeleteInstancesApi) Do(ctx context.Context, credential core.Credential, req *CtecsBatchDeleteInstancesRequest) (*CtecsBatchDeleteInstancesResponse, error) {
	...
	var resp CtecsBatchDeleteInstancesResponse
