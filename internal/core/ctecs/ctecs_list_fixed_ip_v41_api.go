...
// CtecsListFixedIpV41Api
/* 根据云主机ID，查询云主机的固定IP<br/><b>准备工作：</b><br/>&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br />
...
func NewCtecsListFixedIpV41Api(client *core.CtyunClient) *CtecsListFixedIpV41Api {
	return &CtecsListFixedIpV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/ecs/fixed-ip-list",
...
func (a *CtecsListFixedIpV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsListFixedIpV41Request) (*CtecsListFixedIpV41Response, error) {
	...
	var resp CtecsListFixedIpV41Response
