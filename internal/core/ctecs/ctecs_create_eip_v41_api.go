...
// CtecsCreateEipV41Api
/* 调用此接口可创建弹性公网IP（Elastic IP Address，简称EIP）<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看构造请求<br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看认证鉴权&emsp;&emsp;计费说明：确认创建弹性IP的计费方式和价格，详细查看<a href="https://www.ctyun.cn/document/10026753/10027021">计费说明</a><br />&emsp;&emsp;地域选择：选择创建弹性IP的资源池，详细查看<a href="https://www.ctyun.cn/document/10026730/10028695">地域和可用区</a><br />&emsp;&emsp;资源规格和配额限制：请确定弹性IP的带宽选择与配额限制，详细查看<a href="https://www.ctyun.cn/document/10026753/10027007">规格和使用限制</a><br />
...
func (a *CtecsCreateEipV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsCreateEipV41Request) (*CtecsCreateEipV41Response, error) {
	...
	var resp CtecsCreateEipV41Response
