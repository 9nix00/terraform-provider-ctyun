...
// CtecsCreateSnapshotpolicyV41Api
/* 该接口提供用户创建云主机快照策略的功能，快照策略可以通过设置相关参数，定时进行快照任务<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项：</b><br />&emsp;&emsp;用户配额：创建快照策略时需要注意配额，确认个人在不同资源池下资源配额，可以通过<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=9714&data=87">用户配额查询</a>接口进行查询<br />
...
func NewCtecsCreateSnapshotpolicyV41Api(client *core.CtyunClient) *CtecsCreateSnapshotpolicyV41Api {
	return &CtecsCreateSnapshotpolicyV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ecs/snapshot-policy/create",
...
func (a *CtecsCreateSnapshotpolicyV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsCreateSnapshotpolicyV41Request) (*CtecsCreateSnapshotpolicyV41Response, error) {
	...
	var resp CtecsCreateSnapshotpolicyV41Response
