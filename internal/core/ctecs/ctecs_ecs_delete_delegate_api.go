...
// CtecsEcsDeleteDelegateApi
/* 该接口提供用户云主机清除绑定的委托能力，委托信息将以用户元数据数据形式存入，无委托情况下，清除委托依旧返回正确（执行委托置空操作）<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87">认证鉴权</a><br />
...
func NewCtecsEcsDeleteDelegateApi(client *core.CtyunClient) *CtecsEcsDeleteDelegateApi {
	return &CtecsEcsDeleteDelegateApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtecsEcsDeleteDelegateApi) Do(ctx context.Context, credential core.Credential, req *CtecsEcsDeleteDelegateRequest) (*CtecsEcsDeleteDelegateResponse, error) {
	...
	var resp CtecsEcsDeleteDelegateResponse
