...
// CtecsStopLiteInstanceV41Api
/* 该接口提供用户关闭一台轻量型云主机功能<br/><b>准备工作：</b><br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><br /><b>注意事项：</b><br />&emsp;&emsp;异步接口：该接口为异步接口，请求过后会拿到任务ID（jobID），后续可以调用<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=5543&data=87">查询一个异步任务的结果</a>来查询操作是否成功
...
func NewCtecsStopLiteInstanceV41Api(client *core.CtyunClient) *CtecsStopLiteInstanceV41Api {
	return &CtecsStopLiteInstanceV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ecs/lite/stop",
...
func (a *CtecsStopLiteInstanceV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsStopLiteInstanceV41Request) (*CtecsStopLiteInstanceV41Response, error) {
	...
	var resp CtecsStopLiteInstanceV41Response
