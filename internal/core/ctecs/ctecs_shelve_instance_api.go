...
// CtecsShelveInstanceApi
/* 该接口提供用户对一台云主机节省关机功能，请求下发后云主机变为节省关机中（shelving）状态，待异步任务完成后，云主机变为节省关机（shelve）状态<br /><b>准备工作：</b><br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项：</b><br />&emsp;&emsp;单台操作：当前接口只能操作单台云主机，关闭多台云主机请使用接口<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8304&data=87">关闭多台云主机</a>进行操作<br />&emsp;&emsp;异步接口：该接口为异步接口，当云主机状态变为节省关机（shelve）状态时，异步操作结果成功
...
func (a *CtecsShelveInstanceApi) Do(ctx context.Context, credential core.Credential, req *CtecsShelveInstanceRequest) (*CtecsShelveInstanceResponse, error) {
	...
	var resp CtecsShelveInstanceResponse
