...
// CtecsUpdateSpecLiteInstanceV41Api
/* 该接口提供用户升级一台轻量型云主机规格套餐<br /><b>准备工作</b>：<br />&emsp;&emsp;构造请求：在调用前需要了解如何构造请求，详情查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u6784%u9020%u8BF7%u6C42&data=87&vid=81">构造请求</a><br />&emsp;&emsp;认证鉴权：openapi请求需要进行加密调用，详细查看<a href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=%u8BA4%u8BC1%u9274%u6743&data=87&vid=81">认证鉴权</a><br /><b>注意事项：</b><br/>&emsp;&emsp;成本估算：了解云主机的计费项，详细查看<a href="https://www.ctyun.cn/document/10114925/10115703">价格总览</a>进行成本估算<br />&emsp;&emsp;异步接口：该接口为异步接口，下单成功不代表业务成功
...
func NewCtecsUpdateSpecLiteInstanceV41Api(client *core.CtyunClient) *CtecsUpdateSpecLiteInstanceV41Api {
	return &CtecsUpdateSpecLiteInstanceV41Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ecs/lite/update-spec",
...
func (a *CtecsUpdateSpecLiteInstanceV41Api) Do(ctx context.Context, credential core.Credential, req *CtecsUpdateSpecLiteInstanceV41Request) (*CtecsUpdateSpecLiteInstanceV41Response, error) {
	...
	var resp CtecsUpdateSpecLiteInstanceV41Response
