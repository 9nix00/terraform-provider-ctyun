...
func NewCtvpcDeleteSnatEntryApi(client *core.CtyunClient) *CtvpcDeleteSnatEntryApi {
	return &CtvpcDeleteSnatEntryApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/delete-snat-entry",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteSnatEntryApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteSnatEntryRequest) (*CtvpcDeleteSnatEntryResponse, error) {
	...
	var resp CtvpcDeleteSnatEntryResponse
