...
// CtvpcUpdatePrivateZoneRecordAttributeApi
/* 修改内网 DNS 记录
...
func NewCtvpcUpdatePrivateZoneRecordAttributeApi(client *core.CtyunClient) *CtvpcUpdatePrivateZoneRecordAttributeApi {
	return &CtvpcUpdatePrivateZoneRecordAttributeApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/private-zone-record/update",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcUpdatePrivateZoneRecordAttributeApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUpdatePrivateZoneRecordAttributeRequest) (*CtvpcUpdatePrivateZoneRecordAttributeResponse, error) {
	...
	var resp CtvpcUpdatePrivateZoneRecordAttributeResponse
