...
func NewCtvpcIplistenerUpdateApi(client *core.CtyunClient) *CtvpcIplistenerUpdateApi {
	return &CtvpcIplistenerUpdateApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcIplistenerUpdateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcIplistenerUpdateRequest) (*CtvpcIplistenerUpdateResponse, error) {
	...
	var resp CtvpcIplistenerUpdateResponse
