...
// CtvpcDisassociateEipsFromSnatApi
/* SNAT移除EIP
...
func NewCtvpcDisassociateEipsFromSnatApi(client *core.CtyunClient) *CtvpcDisassociateEipsFromSnatApi {
	return &CtvpcDisassociateEipsFromSnatApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/revoke-snat-for-eips",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDisassociateEipsFromSnatApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDisassociateEipsFromSnatRequest) (*CtvpcDisassociateEipsFromSnatResponse, error) {
	...
	var resp CtvpcDisassociateEipsFromSnatResponse
