...
func (a *CtvpcGwlbDeleteApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbDeleteRequest) (*CtvpcGwlbDeleteResponse, error) {
	...
	var resp CtvpcGwlbDeleteResponse
