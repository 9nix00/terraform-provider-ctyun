...
func (a *CtvpcDeleteEipApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteEipRequest) (*CtvpcDeleteEipResponse, error) {
	...
	var resp CtvpcDeleteEipResponse
