...
func NewCtvpcDeleteRouteTableRulesApi(client *core.CtyunClient) *CtvpcDeleteRouteTableRulesApi {
	return &CtvpcDeleteRouteTableRulesApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/route-table/delete-rules",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteRouteTableRulesApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteRouteTableRulesRequest) (*CtvpcDeleteRouteTableRulesResponse, error) {
	...
	var resp CtvpcDeleteRouteTableRulesResponse
