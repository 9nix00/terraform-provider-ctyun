...
func NewCtvpcStartFlowSessionApi(client *core.CtyunClient) *CtvpcStartFlowSessionApi {
	return &CtvpcStartFlowSessionApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/flowsession/start",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcStartFlowSessionApi) Do(ctx context.Context, credential core.Credential, req *CtvpcStartFlowSessionRequest) (*CtvpcStartFlowSessionResponse, error) {
	...
	var resp CtvpcStartFlowSessionResponse
