...
func NewCtvpcDeleteAclApi(client *core.CtyunClient) *CtvpcDeleteAclApi {
	return &CtvpcDeleteAclApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/acl/delete",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteAclApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteAclRequest) (*CtvpcDeleteAclResponse, error) {
	...
	var resp CtvpcDeleteAclResponse
