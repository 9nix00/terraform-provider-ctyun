...
func NewCtvpcGwlbUpdateTargetApi(client *core.CtyunClient) *CtvpcGwlbUpdateTargetApi {
	return &CtvpcGwlbUpdateTargetApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcGwlbUpdateTargetApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbUpdateTargetRequest) (*CtvpcGwlbUpdateTargetResponse, error) {
	...
	var resp CtvpcGwlbUpdateTargetResponse
