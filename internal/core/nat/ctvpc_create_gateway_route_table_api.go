...
// CtvpcCreateGatewayRouteTableApi
/* 创建网关路由表
...
func NewCtvpcCreateGatewayRouteTableApi(client *core.CtyunClient) *CtvpcCreateGatewayRouteTableApi {
	return &CtvpcCreateGatewayRouteTableApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/route-table/create-gateway-routetable",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcCreateGatewayRouteTableApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateGatewayRouteTableRequest) (*CtvpcCreateGatewayRouteTableResponse, error) {
	...
	var resp CtvpcCreateGatewayRouteTableResponse
