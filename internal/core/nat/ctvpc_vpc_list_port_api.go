...
func NewCtvpcVpcListPortApi(client *core.CtyunClient) *CtvpcVpcListPortApi {
	return &CtvpcVpcListPortApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/ports/list",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcVpcListPortApi) Do(ctx context.Context, credential core.Credential, req *CtvpcVpcListPortRequest) (*CtvpcVpcListPortResponse, error) {
	...
	var resp CtvpcVpcListPortResponse
