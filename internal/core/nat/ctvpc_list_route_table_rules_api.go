...
func NewCtvpcListRouteTableRulesApi(client *core.CtyunClient) *CtvpcListRouteTableRulesApi {
	return &CtvpcListRouteTableRulesApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/vpc/route-table/list-rules",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcListRouteTableRulesApi) Do(ctx context.Context, credential core.Credential, req *CtvpcListRouteTableRulesRequest) (*CtvpcListRouteTableRulesResponse, error) {
	...
	var resp CtvpcListRouteTableRulesResponse
