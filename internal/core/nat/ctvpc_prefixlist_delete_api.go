...
func NewCtvpcPrefixlistDeleteApi(client *core.CtyunClient) *CtvpcPrefixlistDeleteApi {
	return &CtvpcPrefixlistDeleteApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/prefixlist/delete",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcPrefixlistDeleteApi) Do(ctx context.Context, credential core.Credential, req *CtvpcPrefixlistDeleteRequest) (*CtvpcPrefixlistDeleteResponse, error) {
	...
	var resp CtvpcPrefixlistDeleteResponse
