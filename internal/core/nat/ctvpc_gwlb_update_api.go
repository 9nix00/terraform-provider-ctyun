...
func (a *CtvpcGwlbUpdateApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbUpdateRequest) (*CtvpcGwlbUpdateResponse, error) {
	...
	var resp CtvpcGwlbUpdateResponse
