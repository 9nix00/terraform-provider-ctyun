...
func NewCtvpcDhcplistvpcApi(client *core.CtyunClient) *CtvpcDhcplistvpcApi {
	return &CtvpcDhcplistvpcApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/dhcpoptionsets/dhcp_list_vpc",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDhcplistvpcApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDhcplistvpcRequest) (*CtvpcDhcplistvpcResponse, error) {
	...
	var resp CtvpcDhcplistvpcResponse
