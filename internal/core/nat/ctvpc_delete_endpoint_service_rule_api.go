...
// CtvpcDeleteEndpointServiceRuleApi
/* 终端节点服务端口映射删除接口
...
func NewCtvpcDeleteEndpointServiceRuleApi(client *core.CtyunClient) *CtvpcDeleteEndpointServiceRuleApi {
	return &CtvpcDeleteEndpointServiceRuleApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpce/delete-endpoint-service-rule",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteEndpointServiceRuleApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteEndpointServiceRuleRequest) (*CtvpcDeleteEndpointServiceRuleResponse, error) {
	...
	var resp CtvpcDeleteEndpointServiceRuleResponse
