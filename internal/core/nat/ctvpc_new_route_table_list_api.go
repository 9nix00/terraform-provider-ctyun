...
func NewCtvpcNewRouteTableListApi(client *core.CtyunClient) *CtvpcNewRouteTableListApi {
	return &CtvpcNewRouteTableListApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/vpc/route-table/new-list",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcNewRouteTableListApi) Do(ctx context.Context, credential core.Credential, req *CtvpcNewRouteTableListRequest) (*CtvpcNewRouteTableListResponse, error) {
	...
	var resp CtvpcNewRouteTableListResponse
