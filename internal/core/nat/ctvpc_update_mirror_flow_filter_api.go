...
// CtvpcUpdateMirrorFlowFilterApi
/* 更新过滤条件
...
func NewCtvpcUpdateMirrorFlowFilterApi(client *core.CtyunClient) *CtvpcUpdateMirrorFlowFilterApi {
	return &CtvpcUpdateMirrorFlowFilterApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/mirrorflow/update-filter",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcUpdateMirrorFlowFilterApi) Do(ctx context.Context, credential core.Credential, req *CtvpcUpdateMirrorFlowFilterRequest) (*CtvpcUpdateMirrorFlowFilterResponse, error) {
	...
	var resp CtvpcUpdateMirrorFlowFilterResponse
