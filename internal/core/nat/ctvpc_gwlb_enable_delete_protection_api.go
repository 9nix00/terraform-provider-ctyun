...
// CtvpcGwlbEnableDeleteProtectionApi
/* 网关负载均衡开启删除保护
...
func NewCtvpcGwlbEnableDeleteProtectionApi(client *core.CtyunClient) *CtvpcGwlbEnableDeleteProtectionApi {
	return &CtvpcGwlbEnableDeleteProtectionApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtvpcGwlbEnableDeleteProtectionApi) Do(ctx context.Context, credential core.Credential, req *CtvpcGwlbEnableDeleteProtectionRequest) (*CtvpcGwlbEnableDeleteProtectionResponse, error) {
	...
	var resp CtvpcGwlbEnableDeleteProtectionResponse
