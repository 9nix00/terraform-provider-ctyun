...
func NewCtvpcV4PortsAsyncAttachBmApi(client *core.CtyunClient) *CtvpcV4PortsAsyncAttachBmApi {
	return &CtvpcV4PortsAsyncAttachBmApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ports/async-attach-bm",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcV4PortsAsyncAttachBmApi) Do(ctx context.Context, credential core.Credential, req *CtvpcV4PortsAsyncAttachBmRequest) (*CtvpcV4PortsAsyncAttachBmResponse, error) {
	...
	var resp CtvpcV4PortsAsyncAttachBmResponse
