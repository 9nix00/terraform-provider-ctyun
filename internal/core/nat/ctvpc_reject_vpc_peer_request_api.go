...
func NewCtvpcRejectVpcPeerRequestApi(client *core.CtyunClient) *CtvpcRejectVpcPeerRequestApi {
	return &CtvpcRejectVpcPeerRequestApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/vpcpeer/reject-request",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcRejectVpcPeerRequestApi) Do(ctx context.Context, credential core.Credential, req *CtvpcRejectVpcPeerRequestRequest) (*CtvpcRejectVpcPeerRequestResponse, error) {
	...
	var resp CtvpcRejectVpcPeerRequestResponse
