...
func NewCtvpcEipQueryRenewPriceApi(client *core.CtyunClient) *CtvpcEipQueryRenewPriceApi {
	return &CtvpcEipQueryRenewPriceApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/eip/query-renew-price",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcEipQueryRenewPriceApi) Do(ctx context.Context, credential core.Credential, req *CtvpcEipQueryRenewPriceRequest) (*CtvpcEipQueryRenewPriceResponse, error) {
	...
	var resp CtvpcEipQueryRenewPriceResponse
