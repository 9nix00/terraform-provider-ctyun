...
// CtvpcVniaListInstanceDiagnosisApi
/* 获取实例诊断列表
...
func NewCtvpcVniaListInstanceDiagnosisApi(client *core.CtyunClient) *CtvpcVniaListInstanceDiagnosisApi {
	return &CtvpcVniaListInstanceDiagnosisApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v4/vnia/list-instance-diagnosis",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcVniaListInstanceDiagnosisApi) Do(ctx context.Context, credential core.Credential, req *CtvpcVniaListInstanceDiagnosisRequest) (*CtvpcVniaListInstanceDiagnosisResponse, error) {
	...
	var resp CtvpcVniaListInstanceDiagnosisResponse
