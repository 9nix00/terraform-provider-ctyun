...
// CtvpcCreateEndpointServiceWhitelistApi
/* 添加终端节点服务白名单
...
func NewCtvpcCreateEndpointServiceWhitelistApi(client *core.CtyunClient) *CtvpcCreateEndpointServiceWhitelistApi {
	return &CtvpcCreateEndpointServiceWhitelistApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpce/create-endpoint-service-whitelist",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcCreateEndpointServiceWhitelistApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateEndpointServiceWhitelistRequest) (*CtvpcCreateEndpointServiceWhitelistResponse, error) {
	...
	var resp CtvpcCreateEndpointServiceWhitelistResponse
