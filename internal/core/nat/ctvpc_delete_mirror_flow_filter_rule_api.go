...
// CtvpcDeleteMirrorFlowFilterRuleApi
/* 删除过滤规则
...
func NewCtvpcDeleteMirrorFlowFilterRuleApi(client *core.CtyunClient) *CtvpcDeleteMirrorFlowFilterRuleApi {
	return &CtvpcDeleteMirrorFlowFilterRuleApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/mirrorflow/delete-filter-rule",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteMirrorFlowFilterRuleApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteMirrorFlowFilterRuleRequest) (*CtvpcDeleteMirrorFlowFilterRuleResponse, error) {
	...
	var resp CtvpcDeleteMirrorFlowFilterRuleResponse
