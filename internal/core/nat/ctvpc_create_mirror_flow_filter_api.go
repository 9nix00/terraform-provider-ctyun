...
// CtvpcCreateMirrorFlowFilterApi
/* 创建过滤条件
...
func NewCtvpcCreateMirrorFlowFilterApi(client *core.CtyunClient) *CtvpcCreateMirrorFlowFilterApi {
	return &CtvpcCreateMirrorFlowFilterApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/mirrorflow/create-filter",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcCreateMirrorFlowFilterApi) Do(ctx context.Context, credential core.Credential, req *CtvpcCreateMirrorFlowFilterRequest) (*CtvpcCreateMirrorFlowFilterResponse, error) {
	...
	var resp CtvpcCreateMirrorFlowFilterResponse
