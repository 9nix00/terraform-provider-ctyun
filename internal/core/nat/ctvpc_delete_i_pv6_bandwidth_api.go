...
func NewCtvpcDeleteIPv6BandwidthApi(client *core.CtyunClient) *CtvpcDeleteIPv6BandwidthApi {
	return &CtvpcDeleteIPv6BandwidthApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ipv6_bandwidth/delete",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDeleteIPv6BandwidthApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDeleteIPv6BandwidthRequest) (*CtvpcDeleteIPv6BandwidthResponse, error) {
	...
	var resp CtvpcDeleteIPv6BandwidthResponse
