...
func NewCtvpcVpceUpdateBackendApi(client *core.CtyunClient) *CtvpcVpceUpdateBackendApi {
	return &CtvpcVpceUpdateBackendApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpce/update-backend",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcVpceUpdateBackendApi) Do(ctx context.Context, credential core.Credential, req *CtvpcVpceUpdateBackendRequest) (*CtvpcVpceUpdateBackendResponse, error) {
	...
	var resp CtvpcVpceUpdateBackendResponse
