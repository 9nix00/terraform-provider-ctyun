...
func NewCtvpcDisassociateSubnetAclApi(client *core.CtyunClient) *CtvpcDisassociateSubnetAclApi {
	return &CtvpcDisassociateSubnetAclApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/vpc/disassociate-subnet-acl",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcDisassociateSubnetAclApi) Do(ctx context.Context, credential core.Credential, req *CtvpcDisassociateSubnetAclRequest) (*CtvpcDisassociateSubnetAclResponse, error) {
	...
	var resp CtvpcDisassociateSubnetAclResponse
