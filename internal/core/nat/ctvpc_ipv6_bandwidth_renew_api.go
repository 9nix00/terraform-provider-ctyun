...
func NewCtvpcIpv6BandwidthRenewApi(client *core.CtyunClient) *CtvpcIpv6BandwidthRenewApi {
	return &CtvpcIpv6BandwidthRenewApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/ipv6_bandwidth/renew",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcIpv6BandwidthRenewApi) Do(ctx context.Context, credential core.Credential, req *CtvpcIpv6BandwidthRenewRequest) (*CtvpcIpv6BandwidthRenewResponse, error) {
	...
	var resp CtvpcIpv6BandwidthRenewResponse
