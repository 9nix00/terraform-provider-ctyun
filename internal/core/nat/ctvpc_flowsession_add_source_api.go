...
func NewCtvpcFlowsessionAddSourceApi(client *core.CtyunClient) *CtvpcFlowsessionAddSourceApi {
	return &CtvpcFlowsessionAddSourceApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v4/flowsession/add-source",
			ContentType:  "application/json",
		},
	}
}

func (a *CtvpcFlowsessionAddSourceApi) Do(ctx context.Context, credential core.Credential, req *CtvpcFlowsessionAddSourceRequest) (*CtvpcFlowsessionAddSourceResponse, error) {
	...
	var resp CtvpcFlowsessionAddSourceResponse
