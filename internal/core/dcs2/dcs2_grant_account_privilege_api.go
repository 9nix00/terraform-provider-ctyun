...
func NewDcs2GrantAccountPrivilegeApi(client *core.CtyunClient) *Dcs2GrantAccountPrivilegeApi {
	return &Dcs2GrantAccountPrivilegeApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/userMgr/grantAccountPrivilege",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2GrantAccountPrivilegeApi) Do(ctx context.Context, credential core.Credential, req *Dcs2GrantAccountPrivilegeRequest) (*Dcs2GrantAccountPrivilegeResponse, error) {
	...
	var resp Dcs2GrantAccountPrivilegeResponse
