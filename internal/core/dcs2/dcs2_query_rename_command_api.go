...
// Dcs2QueryRenameCommandApi
/* 查询分布式缓存Redis实例危险命令重命名状态。
...
func NewDcs2QueryRenameCommandApi(client *core.CtyunClient) *Dcs2QueryRenameCommandApi {
	return &Dcs2QueryRenameCommandApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/securityMgrServant/queryRenameCommand",
			ContentType:  "",
		},
	}
}

func (a *Dcs2QueryRenameCommandApi) Do(ctx context.Context, credential core.Credential, req *Dcs2QueryRenameCommandRequest) (*Dcs2QueryRenameCommandResponse, error) {
	...
	var resp Dcs2QueryRenameCommandResponse
