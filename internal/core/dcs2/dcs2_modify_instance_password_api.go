...
func NewDcs2ModifyInstancePasswordApi(client *core.CtyunClient) *Dcs2ModifyInstancePasswordApi {
	return &Dcs2ModifyInstancePasswordApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/modifyInstancePassword",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2ModifyInstancePasswordApi) Do(ctx context.Context, credential core.Credential, req *Dcs2ModifyInstancePasswordRequest) (*Dcs2ModifyInstancePasswordResponse, error) {
	...
	var resp Dcs2ModifyInstancePasswordResponse
