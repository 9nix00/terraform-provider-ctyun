...
// Dcs2DescribeTopBigKeysPolicyApi
/* 查询大key自动分析策略。
...
func NewDcs2DescribeTopBigKeysPolicyApi(client *core.CtyunClient) *Dcs2DescribeTopBigKeysPolicyApi {
	return &Dcs2DescribeTopBigKeysPolicyApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/keyAnalysisMgrServant/describeTopBigKeysPolicy",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DescribeTopBigKeysPolicyApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DescribeTopBigKeysPolicyRequest) (*Dcs2DescribeTopBigKeysPolicyResponse, error) {
	...
	var resp Dcs2DescribeTopBigKeysPolicyResponse
