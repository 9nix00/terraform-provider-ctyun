...
// Dcs2UpgradeInstanceProxyMinorVersionApi
/* 缓存升级代理版本。
...
func NewDcs2UpgradeInstanceProxyMinorVersionApi(client *core.CtyunClient) *Dcs2UpgradeInstanceProxyMinorVersionApi {
	return &Dcs2UpgradeInstanceProxyMinorVersionApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/upgradeInstanceProxyMinorVersion",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2UpgradeInstanceProxyMinorVersionApi) Do(ctx context.Context, credential core.Credential, req *Dcs2UpgradeInstanceProxyMinorVersionRequest) (*Dcs2UpgradeInstanceProxyMinorVersionResponse, error) {
	...
	var resp Dcs2UpgradeInstanceProxyMinorVersionResponse
