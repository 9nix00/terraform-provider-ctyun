...
func NewDcs2UpdateSlavePriorityApi(client *core.CtyunClient) *Dcs2UpdateSlavePriorityApi {
	return &Dcs2UpdateSlavePriorityApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceParam/updateSlavePriority",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2UpdateSlavePriorityApi) Do(ctx context.Context, credential core.Credential, req *Dcs2UpdateSlavePriorityRequest) (*Dcs2UpdateSlavePriorityResponse, error) {
	...
	var resp Dcs2UpdateSlavePriorityResponse
