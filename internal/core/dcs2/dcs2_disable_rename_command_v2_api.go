...
func NewDcs2DisableRenameCommandV2Api(client *core.CtyunClient) *Dcs2DisableRenameCommandV2Api {
	return &Dcs2DisableRenameCommandV2Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/securityMgrServant/disableRenameCommand",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DisableRenameCommandV2Api) Do(ctx context.Context, credential core.Credential, req *Dcs2DisableRenameCommandV2Request) (*Dcs2DisableRenameCommandV2Response, error) {
	...
	var resp Dcs2DisableRenameCommandV2Response
