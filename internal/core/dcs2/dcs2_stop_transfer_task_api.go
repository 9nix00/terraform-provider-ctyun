...
func NewDcs2StopTransferTaskApi(client *core.CtyunClient) *Dcs2StopTransferTaskApi {
	return &Dcs2StopTransferTaskApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/transfer/stopTransferTask",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2StopTransferTaskApi) Do(ctx context.Context, credential core.Credential, req *Dcs2StopTransferTaskRequest) (*Dcs2StopTransferTaskResponse, error) {
	...
	var resp Dcs2StopTransferTaskResponse
