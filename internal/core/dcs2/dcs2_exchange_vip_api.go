...
func NewDcs2ExchangeVipApi(client *core.CtyunClient) *Dcs2ExchangeVipApi {
	return &Dcs2ExchangeVipApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/transfer/exchangeVip",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2ExchangeVipApi) Do(ctx context.Context, credential core.Credential, req *Dcs2ExchangeVipRequest) (*Dcs2ExchangeVipResponse, error) {
	...
	var resp Dcs2ExchangeVipResponse
