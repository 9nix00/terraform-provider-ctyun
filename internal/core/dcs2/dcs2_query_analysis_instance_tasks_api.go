...
// Dcs2QueryAnalysisInstanceTasksApi
/* 查询分布式缓存Redis诊断分析报告列表
...
func NewDcs2QueryAnalysisInstanceTasksApi(client *core.CtyunClient) *Dcs2QueryAnalysisInstanceTasksApi {
	return &Dcs2QueryAnalysisInstanceTasksApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/keyAnalysisMgrServant/queryAnalysisInstanceTasks",
			ContentType:  "",
		},
	}
}

func (a *Dcs2QueryAnalysisInstanceTasksApi) Do(ctx context.Context, credential core.Credential, req *Dcs2QueryAnalysisInstanceTasksRequest) (*Dcs2QueryAnalysisInstanceTasksResponse, error) {
	...
	var resp Dcs2QueryAnalysisInstanceTasksResponse
