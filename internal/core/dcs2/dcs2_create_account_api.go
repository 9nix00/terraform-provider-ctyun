...
// Dcs2CreateAccountApi
/* 创建分布式缓存Redis实例特定权限的账号。
...
func NewDcs2CreateAccountApi(client *core.CtyunClient) *Dcs2CreateAccountApi {
	return &Dcs2CreateAccountApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/userMgr/createAccount",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2CreateAccountApi) Do(ctx context.Context, credential core.Credential, req *Dcs2CreateAccountRequest) (*Dcs2CreateAccountResponse, error) {
	...
	var resp Dcs2CreateAccountResponse
