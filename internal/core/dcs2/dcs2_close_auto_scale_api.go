...
func NewDcs2CloseAutoScaleApi(client *core.CtyunClient) *Dcs2CloseAutoScaleApi {
	return &Dcs2CloseAutoScaleApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/closeAutoScale",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2CloseAutoScaleApi) Do(ctx context.Context, credential core.Credential, req *Dcs2CloseAutoScaleRequest) (*Dcs2CloseAutoScaleResponse, error) {
	...
	var resp Dcs2CloseAutoScaleResponse
