...
func NewDcs2DownloadSslCertApi(client *core.CtyunClient) *Dcs2DownloadSslCertApi {
	return &Dcs2DownloadSslCertApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/securityMgrServant/downloadSslCert",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DownloadSslCertApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DownloadSslCertRequest) (*Dcs2DownloadSslCertResponse, error) {
	...
	var resp Dcs2DownloadSslCertResponse
