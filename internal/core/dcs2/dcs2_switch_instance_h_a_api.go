...
func NewDcs2SwitchInstanceHAApi(client *core.CtyunClient) *Dcs2SwitchInstanceHAApi {
	return &Dcs2SwitchInstanceHAApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/switchInstanceHA",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2SwitchInstanceHAApi) Do(ctx context.Context, credential core.Credential, req *Dcs2SwitchInstanceHARequest) (*Dcs2SwitchInstanceHAResponse, error) {
	...
	var resp Dcs2SwitchInstanceHAResponse
