...
// Dcs2DescribeNodeMonitorItemsApi
/* 查询分布式缓存Redis实例命令调用类族列表。
...
func NewDcs2DescribeNodeMonitorItemsApi(client *core.CtyunClient) *Dcs2DescribeNodeMonitorItemsApi {
	return &Dcs2DescribeNodeMonitorItemsApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/monitorManageMgrServant/describeNodeMonitorItems",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DescribeNodeMonitorItemsApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DescribeNodeMonitorItemsRequest) (*Dcs2DescribeNodeMonitorItemsResponse, error) {
	...
	var resp Dcs2DescribeNodeMonitorItemsResponse
