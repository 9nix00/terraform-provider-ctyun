...
func NewDcs2GetTaskInfoApi(client *core.CtyunClient) *Dcs2GetTaskInfoApi {
	return &Dcs2GetTaskInfoApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/taskCenter/getTaskInfo",
			ContentType:  "",
		},
	}
}

func (a *Dcs2GetTaskInfoApi) Do(ctx context.Context, credential core.Credential, req *Dcs2GetTaskInfoRequest) (*Dcs2GetTaskInfoResponse, error) {
	...
	var resp Dcs2GetTaskInfoResponse
