...
func NewDcs2DeleteBackupApi(client *core.CtyunClient) *Dcs2DeleteBackupApi {
	return &Dcs2DeleteBackupApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/redisMgr/deleteBackup",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DeleteBackupApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DeleteBackupRequest) (*Dcs2DeleteBackupResponse, error) {
	...
	var resp Dcs2DeleteBackupResponse
