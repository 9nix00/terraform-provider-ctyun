...
func NewDcs2DescribeInstancesApi(client *core.CtyunClient) *Dcs2DescribeInstancesApi {
	return &Dcs2DescribeInstancesApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/instanceManageMgrServant/describeInstances",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DescribeInstancesApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DescribeInstancesRequest) (*Dcs2DescribeInstancesResponse, error) {
	...
	var resp Dcs2DescribeInstancesResponse
