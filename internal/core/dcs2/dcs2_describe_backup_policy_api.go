...
// Dcs2DescribeBackupPolicyApi
/* 查询分布式缓存Redis实例的备份策略，包括备份周期、备份时间等
...
func NewDcs2DescribeBackupPolicyApi(client *core.CtyunClient) *Dcs2DescribeBackupPolicyApi {
	return &Dcs2DescribeBackupPolicyApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/redisMgr/describeBackupPolicy",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DescribeBackupPolicyApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DescribeBackupPolicyRequest) (*Dcs2DescribeBackupPolicyResponse, error) {
	...
	var resp Dcs2DescribeBackupPolicyResponse
