...
func NewDcs2DeleteTransferTaskApi(client *core.CtyunClient) *Dcs2DeleteTransferTaskApi {
	return &Dcs2DeleteTransferTaskApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/transfer/deleteTransferTask",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DeleteTransferTaskApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DeleteTransferTaskRequest) (*Dcs2DeleteTransferTaskResponse, error) {
	...
	var resp Dcs2DeleteTransferTaskResponse
