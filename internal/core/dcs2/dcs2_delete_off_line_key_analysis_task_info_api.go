...
// Dcs2DeleteOffLineKeyAnalysisTaskInfoApi
/* 删除离线全量key分析报告
...
func NewDcs2DeleteOffLineKeyAnalysisTaskInfoApi(client *core.CtyunClient) *Dcs2DeleteOffLineKeyAnalysisTaskInfoApi {
	return &Dcs2DeleteOffLineKeyAnalysisTaskInfoApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/keyAnalysisMgrServant/deleteOffLineKeyAnalysisTaskInfo",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DeleteOffLineKeyAnalysisTaskInfoApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DeleteOffLineKeyAnalysisTaskInfoRequest) (*Dcs2DeleteOffLineKeyAnalysisTaskInfoResponse, error) {
	...
	var resp Dcs2DeleteOffLineKeyAnalysisTaskInfoResponse
