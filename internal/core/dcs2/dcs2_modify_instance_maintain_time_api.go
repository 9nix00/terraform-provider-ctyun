...
// Dcs2ModifyInstanceMaintainTimeApi
/* 修改分布式缓存Redis实例可维护时间段。
...
func NewDcs2ModifyInstanceMaintainTimeApi(client *core.CtyunClient) *Dcs2ModifyInstanceMaintainTimeApi {
	return &Dcs2ModifyInstanceMaintainTimeApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/modifyInstanceMaintainTime",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2ModifyInstanceMaintainTimeApi) Do(ctx context.Context, credential core.Credential, req *Dcs2ModifyInstanceMaintainTimeRequest) (*Dcs2ModifyInstanceMaintainTimeResponse, error) {
	...
	var resp Dcs2ModifyInstanceMaintainTimeResponse
