...
// Dcs2DescribeNodeHistoryMonitorValuesApi
/* 查询分布式缓存Redis实例节点的历史性能监控数据。
...
func NewDcs2DescribeNodeHistoryMonitorValuesApi(client *core.CtyunClient) *Dcs2DescribeNodeHistoryMonitorValuesApi {
	return &Dcs2DescribeNodeHistoryMonitorValuesApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/resourceMonitor/describeNodeHistoryMonitorValues",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DescribeNodeHistoryMonitorValuesApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DescribeNodeHistoryMonitorValuesRequest) (*Dcs2DescribeNodeHistoryMonitorValuesResponse, error) {
	...
	var resp Dcs2DescribeNodeHistoryMonitorValuesResponse
