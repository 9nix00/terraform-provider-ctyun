...
func NewDcs2OpenAutoScaleApi(client *core.CtyunClient) *Dcs2OpenAutoScaleApi {
	return &Dcs2OpenAutoScaleApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/openAutoScale",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2OpenAutoScaleApi) Do(ctx context.Context, credential core.Credential, req *Dcs2OpenAutoScaleRequest) (*Dcs2OpenAutoScaleResponse, error) {
	...
	var resp Dcs2OpenAutoScaleResponse
