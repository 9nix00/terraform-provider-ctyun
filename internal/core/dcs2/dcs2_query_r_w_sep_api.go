...
func NewDcs2QueryRWSepApi(client *core.CtyunClient) *Dcs2QueryRWSepApi {
	return &Dcs2QueryRWSepApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/instanceManageMgrServant/queryRWSep",
			ContentType:  "",
		},
	}
}

func (a *Dcs2QueryRWSepApi) Do(ctx context.Context, credential core.Credential, req *Dcs2QueryRWSepRequest) (*Dcs2QueryRWSepResponse, error) {
	...
	var resp Dcs2QueryRWSepResponse
