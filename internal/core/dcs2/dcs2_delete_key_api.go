...
func NewDcs2DeleteKeyApi(client *core.CtyunClient) *Dcs2DeleteKeyApi {
	return &Dcs2DeleteKeyApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/redisDataMgr/deleteKey",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DeleteKeyApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DeleteKeyRequest) (*Dcs2DeleteKeyResponse, error) {
	...
	var resp Dcs2DeleteKeyResponse
