...
func NewDcs2DeleteAccountApi(client *core.CtyunClient) *Dcs2DeleteAccountApi {
	return &Dcs2DeleteAccountApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/userMgr/deleteAccount",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DeleteAccountApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DeleteAccountRequest) (*Dcs2DeleteAccountResponse, error) {
	...
	var resp Dcs2DeleteAccountResponse
