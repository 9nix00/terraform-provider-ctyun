...
// Dcs2FlushExpireKeysApi
/* 清除分布式缓存Redis实例中的过期Key。
...
func NewDcs2FlushExpireKeysApi(client *core.CtyunClient) *Dcs2FlushExpireKeysApi {
	return &Dcs2FlushExpireKeysApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/flushExpireKeys",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2FlushExpireKeysApi) Do(ctx context.Context, credential core.Credential, req *Dcs2FlushExpireKeysRequest) (*Dcs2FlushExpireKeysResponse, error) {
	...
	var resp Dcs2FlushExpireKeysResponse
