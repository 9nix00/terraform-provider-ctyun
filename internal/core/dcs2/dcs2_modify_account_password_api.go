...
func NewDcs2ModifyAccountPasswordApi(client *core.CtyunClient) *Dcs2ModifyAccountPasswordApi {
	return &Dcs2ModifyAccountPasswordApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/userMgr/modifyAccountPassword",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2ModifyAccountPasswordApi) Do(ctx context.Context, credential core.Credential, req *Dcs2ModifyAccountPasswordRequest) (*Dcs2ModifyAccountPasswordResponse, error) {
	...
	var resp Dcs2ModifyAccountPasswordResponse
