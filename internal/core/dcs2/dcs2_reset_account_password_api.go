...
func NewDcs2ResetAccountPasswordApi(client *core.CtyunClient) *Dcs2ResetAccountPasswordApi {
	return &Dcs2ResetAccountPasswordApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/userMgr/resetAccountPassword",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2ResetAccountPasswordApi) Do(ctx context.Context, credential core.Credential, req *Dcs2ResetAccountPasswordRequest) (*Dcs2ResetAccountPasswordResponse, error) {
	...
	var resp Dcs2ResetAccountPasswordResponse
