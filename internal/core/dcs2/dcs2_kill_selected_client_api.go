...
func NewDcs2KillSelectedClientApi(client *core.CtyunClient) *Dcs2KillSelectedClientApi {
	return &Dcs2KillSelectedClientApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/resourceMonitor/killSelectedClient",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2KillSelectedClientApi) Do(ctx context.Context, credential core.Credential, req *Dcs2KillSelectedClientRequest) (*Dcs2KillSelectedClientResponse, error) {
	...
	var resp Dcs2KillSelectedClientResponse
