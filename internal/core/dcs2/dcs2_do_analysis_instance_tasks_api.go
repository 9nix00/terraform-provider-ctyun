...
// Dcs2DoAnalysisInstanceTasksApi
/* 执行分布式缓存Redis实例诊断分析，分析实例可用性、数据同步、负载状态、存储、网络、慢请求、命令耗时统计等信息
...
func NewDcs2DoAnalysisInstanceTasksApi(client *core.CtyunClient) *Dcs2DoAnalysisInstanceTasksApi {
	return &Dcs2DoAnalysisInstanceTasksApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/keyAnalysisMgrServant/doAnalysisInstanceTasks",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2DoAnalysisInstanceTasksApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DoAnalysisInstanceTasksRequest) (*Dcs2DoAnalysisInstanceTasksResponse, error) {
	...
	var resp Dcs2DoAnalysisInstanceTasksResponse
