...
// Dcs2DescribeBigAndHotKeysApi
/* 查询分布式缓存Redis实例的热Key、大key
...
func NewDcs2DescribeBigAndHotKeysApi(client *core.CtyunClient) *Dcs2DescribeBigAndHotKeysApi {
	return &Dcs2DescribeBigAndHotKeysApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v2/keyAnalysisMgrServant/describeBigAndHotKeys",
			ContentType:  "",
		},
	}
}

func (a *Dcs2DescribeBigAndHotKeysApi) Do(ctx context.Context, credential core.Credential, req *Dcs2DescribeBigAndHotKeysRequest) (*Dcs2DescribeBigAndHotKeysResponse, error) {
	...
	var resp Dcs2DescribeBigAndHotKeysResponse
