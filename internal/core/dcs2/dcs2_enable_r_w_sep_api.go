...
func NewDcs2EnableRWSepApi(client *core.CtyunClient) *Dcs2EnableRWSepApi {
	return &Dcs2EnableRWSepApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/instanceManageMgrServant/enableRWSep",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2EnableRWSepApi) Do(ctx context.Context, credential core.Credential, req *Dcs2EnableRWSepRequest) (*Dcs2EnableRWSepResponse, error) {
	...
	var resp Dcs2EnableRWSepResponse
