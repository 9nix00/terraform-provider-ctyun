...
// Dcs2GetLabelListByResourcesApi
...
func NewDcs2GetLabelListByResourcesApi(client *core.CtyunClient) *Dcs2GetLabelListByResourcesApi {
	return &Dcs2GetLabelListByResourcesApi{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPost,
			UrlPath:      "/v2/label/getLabelListByResources",
			ContentType:  "application/json",
		},
	}
}

func (a *Dcs2GetLabelListByResourcesApi) Do(ctx context.Context, credential core.Credential, req *Dcs2GetLabelListByResourcesRequest) (*Dcs2GetLabelListByResourcesResponse, error) {
	...
	var resp Dcs2GetLabelListByResourcesResponse
